defmodule NoosphericalWeb.UserControllerTest do
  use NoosphericalWeb.ConnCase

  alias Noospherical.Accounts

  @create_attrs %{email: "some email", password: "some password", password_hash: "some password_hash", username: "some username"}
